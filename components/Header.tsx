...
function Header() {
  ...
  useEffect(()=>{
    ...
    const fetchSuggestionFunc = await fetchSuggestion(board);
  ...
  return (
    <header>
      <div className="flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl">
        <div className="absolute left-0 top-0 w-full h-96 bg-gradient-to-r from-red-400 to-[#0055D1] rounded-md filter blur-3xl opacity-50 -z-50" />
